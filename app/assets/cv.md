...
- Enjoyed having free reign of a completely green-field project, creating something fast, efficient, and reasonably low-cost using IaC, GitOps, CDK, Lambda, DynamoDB, and API Gateway to seamlessly integrate with existing systems.
