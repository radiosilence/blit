...
export const homePath = i18n.locale !== sourceLocale ? `/${i18n.locale}/` : "/";

<div className="flex flex-col mli-4 lg:mli-0 items-center">
<section className="mb-12 max-w-screen-lg">
  <a href={homePath}>
    <img src={logo} alt="blit.cc logo" width={128} height={128} className="mbs-16 lg:mbs-32 mbe-8" />
  </a>
  <article className="prose prose-sm">
    ...
    **github:** [@radiosilence](https://github.com/radiosilence)
    ...
    <small>
      World's largest beauty & wellness marketplace: 1 billion+ appointments, 120k+ partner businesses
